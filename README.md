...
6. Retrieve relevant chunks for queries
...
1. Scheduler triggers backend
2. Fetch latest papers from APIs
3. Generate structured digest
4. Summarize papers using LLM
